...
public final class DataVisualizer extends ApplicationTemplate {
    ...
    protected final Dialog classificationConfigWindow = ClassificationConfigWindow.getDialog();
    protected final Dialog clusteringConfigWindow = ClusteringConfigWindow.getDialog();
    ...
    protected void dialogsAudit(Stage primaryStage){
        ...
        classificationConfigWindow.init(primaryStage);
        clusteringConfigWindow.init(primaryStage);
    }
